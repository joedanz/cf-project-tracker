...
<cfhtmlhead text='<script type="text/javascript" src="./js/message_comments.js"></script>'>
		...
		<div class="main">
			...
			<div class="content">
				<div class="wrapper msg">
					...
					<a href="##" onclick="return delete_comment('#commentID#');"><img src="./images/delete.png" height="16" width="16" border="0" style="float:right;padding:5px;" /></a>
					</cfif>
