...
<cfif project.recordCount>
	...
	<div class="left">
		<div class="main">
				...
				<div class="content">
					...
					<form action="" class="frm" style="margin:0;padding:0;">
	...
	<div class="right">
		...
		<select name="assignedTo" onchange="this.form.submit();">
			...
			<option value="#session.user.userid#"<cfif not compare(form.assignedTo,session.user.userID)> selected="selected"</cfif>>Me (#session.user.firstName# #session.user.lastName#)</option>
			<cfloop query="projectUsers">
