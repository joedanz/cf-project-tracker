...
<cfset todos = application.todo.get(url.p,url.t)>
	...
	<div class="left">
		<div class="main">
				...
				<div class="content">
					...
					<div class="top"><a href="##" onclick="$('body').ScrollTo(800)"><img src="./images/top.png" height="12" width="31" border="0" alt="Top" /></a></div>
					...
					<h3 class="padtop padbottom list">#title# <span class="itemedit">[<a href="editTodolist.cfm?p=#url.p#&t=#todolistid#">edit</a> / <a href="#cgi.script_name#?p=#url.p#&del=#todolistid#" onclick="return confirm('Are you sure you wish to delete this to-do list?');">del</a>]</span></h3>
						...
						| <a href="##" class="check">Mark List Completed</a>
						</div>
...
<div class="posted">Posted by #firstName# #lastName# on #DateFormat(added,"dddd, mmmm d, yyyy")# (#daysago# Day<cfif daysago neq 1>s</cfif> Ago)</div>
						</div>
