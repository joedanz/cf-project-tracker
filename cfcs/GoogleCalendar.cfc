...
<cffunction name="addEvent" access="public" returnType="any" output="false" hint="Adds an event. Returns Success or another message.">
  ...
  <cfargument name="resultType" type="string" required="false" hint="fileContent, fullResponse, successCode">
  ...
  <cfset var masterStart = arguments.start>
  <cfset var masterEnd = "">


  <cfif structKeyExists(arguments, "allday") AND arguments.allday>
  	<cfset masterEnd = arguments.start>
    <cfelse>
    <cfset masterEnd = arguments.end>
  </cfif>
