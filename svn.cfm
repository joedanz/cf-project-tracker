...
<!--- Loads header/footer --->
<cfmodule template="#application.settings.mapping#/tags/layout.cfm" templatename="main" title="#application.settings.title# &raquo; #project.name#" project="#project.name#" projectid="#url.p#" svnurl="#project.svnurl#">
...
<cfif not compareNoCase(url.act,'browse')>
	...
	<cfif compare(url.wd,'')>
		...
		<tr class="even">
			<td>
			<img src="images/folder.png" height="16" width="16" border="0" alt="Directory" />
	...
	<cfloop from="1" to="#arrayLen(dirEntries)#" index="i">
		...
		<tr class="<cfif thisRow mod 2 eq 1>odd<cfelse>even</cfif>">
			...
			<cfif listFindNoCase('.cfm,.cfc',right(dirEntries[i].name,4))>
				<a href="viewcode.cfm?p=#url.p#&wd=#URLEncodedFormat(url.wd)#&f=#URLEncodedFormat(dirEntries[i].name)#"><img src="images/file_cf.png" height="16" width="16" border="0" alt="ColdFusion File" />
			<cfelseif listFindNoCase('.htm,html',right(dirEntries[i].name,4))>
				<a href="viewcode.cfm?p=#url.p#&wd=#URLEncodedFormat(url.wd)#&f=#URLEncodedFormat(dirEntries[i].name)#"><img src="images/file_htm.png" height="16" width="16" border="0" alt="HTML File" />
			<cfelseif not compareNoCase(right(dirEntries[i].name,3),'.js')>
				<a href="viewcode.cfm?p=#url.p#&wd=#URLEncodedFormat(url.wd)#&f=#URLEncodedFormat(dirEntries[i].name)#"><img src="images/file.png" height="16" width="16" border="0" alt="Javascript File" />
			<cfelseif not compareNoCase(right(dirEntries[i].name,4),'.css')>
				<a href="viewcode.cfm?p=#url.p#&wd=#URLEncodedFormat(url.wd)#&f=#URLEncodedFormat(dirEntries[i].name)#"><img src="images/file.png" height="16" width="16" border="0" alt="CSS File" />
			<cfelse>
				<a href="#cgi.script_name#?p=#url.p#&br=&f=#URLEncodedFormat(dirEntries[i].name)#"><img src="images/file.png" height="16" width="16" border="0" alt="File" />
			</cfif>
			#dirEntries[i].name#</a></td>
