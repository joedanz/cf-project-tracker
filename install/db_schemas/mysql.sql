...
CREATE TABLE `pt_user_notify` (
  ...
  `email_todo_del` tinyint(1) default NULL,
  `mobile_todo_del` tinyint(1) default NULL,
  `email_todo_cmp` tinyint(1) default NULL,
  `mobile_todo_cmp` tinyint(1) default NULL,
