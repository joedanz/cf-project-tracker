...
CREATE TABLE  "PT_PROJECT_USERS" 
   (	"USERID" CHAR(35) NOT NULL ENABLE, 
	"PROJECTID" CHAR(35) NOT NULL ENABLE, 
	"ADMIN" NUMBER(1,0), 
	"FILE_VIEW" NUMBER(1,0), 
	"FILE_ADD" NUMBER(1,0), 
	"FILE_EDIT" NUMBER(1,0), 
	"ISSUE_VIEW" NUMBER(1,0), 
	"ISSUE_ADD" NUMBER(1,0), 
	"ISSUE_EDIT" NUMBER(1,0), 
	"ISSUE_ACCEPT" NUMBER(1,0), 
	"ISSUE_COMMENT" NUMBER(1,0), 
	"MSG_VIEW" NUMBER(1,0), 
	"MSG_ADD" NUMBER(1,0), 
	"MSG_EDIT" NUMBER(1,0), 
	"MSG_COMMENT" NUMBER(1,0), 
	"MSTONE_VIEW" NUMBER(1,0), 
	"MSTONE_ADD" NUMBER(1,0), 
	"MSTONE_EDIT" NUMBER(1,0), 
	"MSTONE_COMMENT" NUMBER(1,0), 
	"TODOLIST_VIEW" NUMBER(1,0), 
	"TODOLIST_ADD" NUMBER(1,0), 
	"TODOLIST_EDIT" NUMBER(1,0), 
	"TODO_ADD" NUMBER(1,0), 
	"TODO_EDIT" NUMBER(1,0), 
	"TODO_COMMENT" NUMBER(1,0), 
	"TIME_VIEW" NUMBER(1,0), 
	"TIME_ADD" NUMBER(1,0), 
	"TIME_EDIT" NUMBER(1,0), 
	"BILL_VIEW" NUMBER(1,0), 
	"BILL_ADD" NUMBER(1,0), 
	"BILL_EDIT" NUMBER(1,0), 
	"BILL_RATES" NUMBER(1,0), 
	"BILL_INVOICES" NUMBER(1,0), 
	"BILL_MARK_PAID" NUMBER(1,0), 
	"SVN" NUMBER(1,0), 
