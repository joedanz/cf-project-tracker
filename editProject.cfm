...
<!--- Loads header/footer --->
<cfmodule template="#application.settings.mapping#/tags/layout.cfm" templatename="main" title="#application.settings.title# &raquo; #title_action# Project" project="#name#" projectid="#projID#" svnurl="#svnurl#">
		...
		<div class="main">
				...
				<div class="content">
					...
					<form action="#cgi.script_name#" method="post" name="edit" id="edit" class="frm" onsubmit="return confirmSubmit();">
						...
						<span style="font-size:.8em">(used when generating trouble tickets)</span>
						</p>
						<fieldset style="border:0;border-top:2px solid ##d9eaf5;margin:0 50px;">
						...
						<input type="text" name="svnurl" id="svnurl" value="#svnurl#" maxlength="100" />
						</p>						
						<p>
						<label for="svnuser">SVN Username:</label>
						<input type="text" name="svnuser" id="svnuser" value="#svnuser#" maxlength="20" />
						</p>						
						<p>
						<label for="svnpass">SVN Password:</label>
						<input type="text" name="svnpass" id="svnpass" value="#svnpass#" maxlength="20" />
						</p>
						</div>
						</fieldset>
