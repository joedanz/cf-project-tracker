...
<cfif StructKeyExists(url,"edit")>
	...
	<table>
		<tr>
			...
			<td><cfif project.todos gt 1 and project.timetrack gt 1 and todolist.timetrack eq 1><img src="./images/time<cfif numTimeTracks gt 0>3<cfelse>2</cfif>.gif" onclick="todo_time('edit','#url.p#','#url.tl#','#url.t#','#url.c#');" /></cfif></td>
